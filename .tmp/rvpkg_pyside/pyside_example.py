...
# By default, we attempt to load PySide2 (for RV 7.5.x+)
versionParts = os.environ["TWK_APP_VERSION"].split(".")
if int(versionParts[0]) > 7 or (versionParts[0] == "7" and int(versionParts[1]) > 4):
