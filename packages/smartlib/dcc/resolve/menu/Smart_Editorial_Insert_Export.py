...
def main() -> None:
    ...
    from smartlib.dcc.resolve import editorial_insert, editorial_insert_ui
    importlib.reload(editorial_insert)
    importlib.reload(editorial_insert_ui)
    editorial_insert_ui.show(config_dir=config_dir, resolve_app=resolve_app)
